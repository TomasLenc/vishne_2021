% This method computes the bGLS for cases *with* significant tempo changes
% - based on Nori Jacoby's bGLS toolbox (2015), adapted by Gal Vishne
% (2019-2021) to deal with missing or excluded values (note we use a
% different formulation of the model than the corresponding function in
% bGLS)
...
function [alphas,betas,st,sm,logp]=model_fit_exp2(R,As,MEAN_A)
